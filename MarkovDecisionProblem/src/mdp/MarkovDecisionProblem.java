...
public class MarkovDecisionProblem {
	...
	private double 	pPerform = 0.7, 	// probability of action being executed as planned 
					pSidestep = 0.2,	// probability of a sidestep being executed
					pBackstep = 0.1,		// probability of the inverse action being executed
	...
	public double getReward(){
		// Note that if the agent reaches a terminal field (i.e. terminated = true), no rewards should be gained anymore and the MDP should be restarted.
